...
<head>
   ...
   <title>Taskers Peru - error 404</title>
...
<body>
   ...
   <?php include('includes/wave-close.html'); ?>
   <?php include('includes/wave-open.html'); ?>
   <?php include('includes/social-media.html'); ?>
   ...
   <main>
      ...
      <p id="errorText">Ups! La página que estas buscando no se encuentra.</p>
      <a id="errorLink" href="/demox">Regresar a Inicio</a>
   </main>
